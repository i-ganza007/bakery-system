    ...
    return (
        <div>
            <div className="flex items-center justify-between gap-20">
                ...
                <div onClick={handleClick}  className="rounded-full w-12 h-12 bg-red-200 flex items-center justify-center cursor-pointer hover:bg-red-300 transition-colors flex-shrink-0">
